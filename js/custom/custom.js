...
$(document).ready(function() {
    ...
    function toggleChevron(e) {
        $(e.target)
            .prev('.panel-heading')
            .find("i.indicator2.html")
            .toggleClass('fa-plus fa-minus');
    }
    $('#accordion').on('hidden.bs.collapse.html', toggleChevron);
    $('#accordion').on('shown.bs.collapse.html', toggleChevron);


    $('.panel-collapse').on('show.bs.collapse.html', function() {
        $(this).prev('.panel-heading').find('.panel-title').addClass("active-panel");
    });

    $('.panel-collapse').on('hide.bs.collapse.html', function() {
